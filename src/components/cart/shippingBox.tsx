...
import { ShippingBoxNotLogged } from "./shippingBoxNotLogged";
import { ShippingBoxLogged } from "./shippingBoxLogged";
            ...
            {cartStore.shippingDays > 0 && (
                <div className="flex items-center bg-white border border-gray-200 rounded-sm p-6">
                    <div className="flex-1">
                        Receba em até {cartStore.shippingDays}
                        {cartStore.shippingDays === 1
                            ? " dia útil"
                            : " dias úteis"}
                    </div>
