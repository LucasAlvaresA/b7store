...
export const ProductDescription = ({ text }: Props) => {
    ...
    return (
        <div className="bg-white border border-gray-200 px-7 mt-24">
            <div
            ...
            >
                ...
                <div
                    ...
                    className={`size-14 border border-gray-200 flex justify-center items-center rounded-sm cursor-pointer`}
                >
                    <Image
